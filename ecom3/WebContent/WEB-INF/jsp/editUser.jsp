	        ...
	        <script type="text/javascript">
	            ...
	            $(document).ready(function(){
	            	...
	            	$('#Update').click(function(){
	            		...
	            		var roleName = document.getElementById("txtNewRole").value;
...
<tr>
  ...
  <td><input type="text" value="" id="txtroleName" disabled></td>
</tr>
<tr>
  <td>
    userName : 
...
<tr>
  ...
  <td>
  	<select id="txtNewRole">
       <c:forEach var="list" items="${ListRoles}">
